      ...
      <>
        <div className="fixed left-0 right-0 bottom-0 z-[950] px-3 pb-3 pointer-events-none">
          <section
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(22,26,48,0.90), rgba(10,12,24,0.94))",
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                ...
                <div className="text-sm font-semibold text-white mt-1">
                  Nessuna lettura attiva
                </div>

                <div className="text-xs text-zinc-500 mt-0.5">
                  Aggiungi un manga al player.
                </div>
              </div>
              ...
              <button
                ...
                className="
                  ...
                  shadow-[0_0_24px_rgba(250,204,21,0.35)]
                  active:scale-95
                  transition
                "
      ...
      <div className="fixed left-0 right-0 bottom-0 z-[950] px-3 pb-3 pointer-events-none">
        <section
          className="
            ...
            p-3
            overflow-hidden
            shadow-[0_24px_60px_rgba(0,0,0,0.46)]
          "
          style={{
            background:
              "linear-gradient(180deg, rgba(22,26,48,0.90), rgba(10,12,24,0.96))",
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -top-10 left-10 w-40 h-40 rounded-full bg-yellow-400/10 blur-3xl" />
            <div className="absolute -bottom-12 right-6 w-36 h-36 rounded-full bg-blue-500/12 blur-3xl" />
          </div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2 min-w-0">
                <div className="w-7 h-7 rounded-xl bg-yellow-400/15 border border-yellow-400/20 text-yellow-300 flex items-center justify-center">
                  <BookIcon />
                </div>
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 pointer-events-none bg-gradient-to-tr from-white/0 via-white/10 to-white/0 opacity-40" />
                  </button>
